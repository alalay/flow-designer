 ...
 */
var f$3=React__default["default"],g$3=60103;reactJsxRuntime_production_min.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h$3=Symbol.for;g$3=h$3("react.element");reactJsxRuntime_production_min.Fragment=h$3("react.fragment");}var m$3=f$3.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n$3=Object.prototype.hasOwnProperty,p$3={key:!0,ref:!0,__self:!0,__source:!0};
function q$3(c,a,k){var b,d={},e=null,l=null;void 0!==k&&(e=""+k);void 0!==a.key&&(e=""+a.key);void 0!==a.ref&&(l=a.ref);for(b in a)n$3.call(a,b)&&!p$3.hasOwnProperty(b)&&(d[b]=a[b]);if(c&&c.defaultProps)for(b in a=c.defaultProps,a)void 0===d[b]&&(d[b]=a[b]);return {$$typeof:g$3,type:c,key:e,ref:l,props:d,_owner:m$3.current}}reactJsxRuntime_production_min.jsx=q$3;reactJsxRuntime_production_min.jsxs=q$3;
...
var Handle = function (_a) {
  ...
  var handleClasses = cc(["react-flow__handle", "react-flow__handle-" + position, {
    source: !isTarget,
    target: isTarget
  }]);
...
var InputNode = function (_a) {
  ...
  return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
    children: [data.label, jsxRuntime.exports.jsx(Handle$1, {
      type: "source",
...
var DefaultNode = function (_a) {
  ...
  return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
    children: [jsxRuntime.exports.jsx(Handle$1, {
      type: "target",
      position: targetPosition,
      isConnectable: isConnectable
    }, void 0), data.label, jsxRuntime.exports.jsx(Handle$1, {
      type: "source",
      position: sourcePosition,
      isConnectable: isConnectable
    }, void 0)]
...
var updateNodeDimensions = function (updates) {
...
function useStoreActions(actionSelector) {
  ...
  var action = bindActionCreators(currAction, dispatch);
  return action;
}
var useStoreState = useTypedSelector;

var NodeRenderer = function (_a) {
  ...
  return jsxRuntime.exports.jsx("div", __assign({
    ...
    children: nodes.map(function (node) {
      ...
      var NodeComponent = nodeTypes[nodeType];
      return jsxRuntime.exports.jsx(NodeComponent, {
        id: node.id,
        type: nodeType,
...
var wrapNode = (function (NodeComponent) {
  var NodeWrapper = function (_a) {
    ...
    var nodeClasses = cc(["react-flow__node", "react-flow__node-" + type]);
    return jsxRuntime.exports.jsx("div", __assign({
      className: nodeClasses,
      style: nodeStyle,
      ref: nodeElement
    }, {
      children: jsxRuntime.exports.jsx(NodeComponent, {
        id: id,
        data: data,
        type: type,
        xPos: xPos,
...
var ElementUpdater = function (_a) {
  ...
  React.useEffect(function () {
    setElements(elements); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [elements]);
  return null;
};
...
function getHandleBounds(nodeElement) {
...
function getHandleBoundsByHandleType(selector, nodeElement, parentBounds) {
...
var parseNode = function (node, nodeExtent) {
...
var parseEdge = function (edge) {
  return __assign(__assign({}, edge), {
    type: edge.type || "default"
  });
};

function reactFlowReducer(state, action) {
  if (state === void 0) {
    state = initialState;
  }
  ...
  switch (action.type) {
    case SET_ELEMENTS:
      {
        ...
        var _a = propElements.reduce(function (res, propElement) {
          if (isNode(propElement)) {
            ...
            if (storeNode) {
              var updateNode = __assign(__assign({}, storeNode), propElement);
            ...
            if (storeEdge) {
              res.nextEdges.push(__assign(__assign({}, storeEdge), propElement));
            } else {
          ...
          return res;
            ...
            nextNodes = _a.nextNodes,
            nextEdges = _a.nextEdges;
    ...
    case UPDATE_NODE_DIMENSIONS:
      {
        var updateNodes = state.nodes.map(function (node) {
          ...
          if (update) {
            ...
            var doUpdate = node.__rf.width !== dimensions.width || node.__rf.height !== dimensions.height || update.forceUpdate;

            if (doUpdate) {
              var handleBounds = getHandleBounds(update.nodeElement);
              return __assign(__assign({}, node), {
                __rf: __assign(__assign(__assign({}, node.__rf), dimensions), {
...
function configureStore(initialState) {
  var store = createStore(reactFlowReducer, initialState, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
  return store;
}
...
var Wrapper = function (_a) {
  ...
  return jsxRuntime.exports.jsx(Provider, __assign({
    store: store
  }, {
    children: children
  }), void 0);
...
function getBezierPath(_a) {
  ...
  var path = "M" + sourceX + "," + sourceY + " C" + sourceX + "," + _centerY + " " + targetX + "," + _centerY + " " + targetX + "," + targetY;
  return path;
}

var BezierEdge = function (_a) {
  var sourceX = _a.sourceX,
      sourceY = _a.sourceY,
      targetX = _a.targetX,
      targetY = _a.targetY;
...
var wrapEdge = function (EdgeComponent) {
  var EdgeWrapper = function (_a) {
    ...
    var edgeClasses = cc(["react-flow__edge", "react-flow__edge-" + type, {
      animated: animated
    }]);
    return jsxRuntime.exports.jsx("g", __assign({
      className: edgeClasses
    }, {
      children: jsxRuntime.exports.jsx(EdgeComponent, {
        sourceX: sourceX,
        sourceY: sourceY,
        targetX: targetX,
        targetY: targetY
...
function getHandlePosition(position, node, handle) {
  ...
  var x = node.__rf.position.x;
  var y = node.__rf.position.y;
  var width = node.__rf.width;
  var height = node.__rf.height;
...
function getEdgePositions(sourceNode, sourceHandle, sourcePosition, targetNode, targetHandle, targetPosition) {
  var sourceHandlePos = getHandlePosition(sourcePosition, sourceNode);
  var targetHandlePos = getHandlePosition(targetPosition, targetNode);
  return {
...
var EdgeC = function (_a) {
  ...
  var EdgeComponent = wrapEdge(BezierEdge);
  return jsxRuntime.exports.jsx(EdgeComponent, {
    type: edge.type,
...
var EdgeRenderder = function () {
  ...
  return jsxRuntime.exports.jsx("svg", __assign({
    width: 1000,
    height: 300
  }, {
    children: jsxRuntime.exports.jsx("g", {
      children: edges.map(function (edge) {
        return jsxRuntime.exports.jsx(EdgeC, {
          edge: edge,
          nodes: nodes
        }, void 0);
      })
...
var defaultNodeTypes = {
  input: wrapNode(InputNode$1),
  default: wrapNode(DefaultNode$1),
  output: wrapNode(OutputNode$1)
};

function ReactFlow(props) {
  return jsxRuntime.exports.jsx("div", {
    children: jsxRuntime.exports.jsxs(Wrapper, {
      children: [jsxRuntime.exports.jsx(ElementUpdater, {
        elements: props.elements
      }, void 0), jsxRuntime.exports.jsx(NodeRenderer, {
        nodeTypes: defaultNodeTypes
      }, void 0), jsxRuntime.exports.jsx(EdgeRenderder, {}, void 0)]
    }, void 0)
  }, void 0);
}
